...
public:
	...
	REF_VALUE_METHOD_DECLARATION(Vector3);
	REF_VALUE_METHOD_DECLARATION(Quaternion);
	REF_VALUE_METHOD_DECLARATION(Vector2);
	...
	REF_SETVALUE_METHOD_DECLARATION(Vector3);
	REF_SETVALUE_METHOD_DECLARATION(Quaternion);
	REF_SETVALUE_METHOD_DECLARATION(Vector2);
